            ...
            <div className="row z-depth-2">
                <div className="col-sm-10 rounded-left">
                    ...
                    {/* className="fas fa-user-tie fa-7x mt-5" */}
                        <img className="imge"  src={user[0].image} />
                ...
                <div className="col-sm-10  rounded-right">
                        <h3 className="mt-1 text-white text-center">Datos del Usuario</h3>
                        <hr className="badge-primary "></hr>
                        <div className="row">
                            <div className="d-flex justify-content-around ">
                                <p className="font-weight-bold text-white"  >Email</p>
                                <h6 className=" text-white">{user[0].email}</h6>
                            </div>
                            <div className="d-flex justify-content-around ">
                                <p className="font-weight-bold text-white" >Rol del Usuario</p>
                                <h6 className=" text-white">{user[0].roles[0].name}</h6>
                            </div>
                            <div className="d-flex justify-content-around ">
                                <p className="font-weight-bold text-white">Canales de Streams</p>
                                <h6 className=" text-white">{user[0].myStreams.length}</h6>
                            </div>
                            <div className="d-flex justify-content-around ">
                                <p className="font-weight-bold text-white">Subcriptores registr</p>
                                <h6 className=" text-white">{user[0].myStreams.length}</h6>
                            </div>
                            <div className="d-flex justify-content-around ">
                                <p className="font-weight-bold text-white">Hash Cash</p>
                                <h6 className=" text-white">{user[0].HashCash}</h6>
                            </div>
                            <div className="d-flex justify-content-around ">
                                <p className="font-weight-bold text-white">Baneado</p>
                                <h6 className=" text-white">{user[0].banned === true?
                                (<>SI</>)
                                :(<>NO</>)}</h6>
                            </div>
                            <div className="d-flex justify-content-around ">
                                <p className="font-weight-bold text-white">Fecha de Creacion</p>
                                <h6 className=" text-white">{user[0].createdAt.slice(0,10)}</h6>
                            </div>
                        </div>
